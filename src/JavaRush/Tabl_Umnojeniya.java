...
public class Tabl_Umnojeniya {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        MULTIPLICATION_TABLE [0] = firstarray;
        for (int i = 1, n = 2; i < MULTIPLICATION_TABLE.length; i ++){
            for (int j = 0; j < MULTIPLICATION_TABLE[i].length; j++){
                MULTIPLICATION_TABLE[i] [j] = MULTIPLICATION_TABLE [0][j]*n;

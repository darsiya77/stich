...
// 53, 84, 72 - если удалить новые строки кода и оставить 3 пустых перед программой
...
//                return false;
//            }
//            return true;                                          заменил на - return Objects.equals(content, that.content);
        }
...
//                return mailBox.getOrDefault(key, Collections.emptyList());
        ...
        public void accept(Sendable<T> s) {
            ...
            // Получаем получателя из Sendable
